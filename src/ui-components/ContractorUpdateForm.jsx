...
export default function ContractorUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = contractorRecord
      ? { ...initialValues, ...contractorRecord }
      : initialValues;
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Contractor, idProp)
        : contractorModelProp;
      setContractorRecord(record);
    };
    queryData();
  }, [idProp, contractorModelProp]);
  React.useEffect(resetStateValues, [contractorRecord]);
  const validations = {
    firstname: [],
    lastname: [],
    phone: [{ type: "Phone" }],
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Contractor.copyOf(contractorRecord, (updated) => {
