...
export declare type AvailableInstallationsCreateFormInputValues = {
...
export declare type AvailableInstallationsCreateFormValidationValues = {
...
export declare type AvailableInstallationsCreateFormOverridesProps = {
    AvailableInstallationsCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type AvailableInstallationsCreateFormProps = React.PropsWithChildren<{
    overrides?: AvailableInstallationsCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: AvailableInstallationsCreateFormInputValues) => AvailableInstallationsCreateFormInputValues;
    onSuccess?: (fields: AvailableInstallationsCreateFormInputValues) => void;
    onError?: (fields: AvailableInstallationsCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: AvailableInstallationsCreateFormInputValues) => AvailableInstallationsCreateFormInputValues;
    onValidate?: AvailableInstallationsCreateFormValidationValues;
} & React.CSSProperties>;
export default function AvailableInstallationsCreateForm(props: AvailableInstallationsCreateFormProps): React.ReactElement;
