...
export default function AvailableInstallationsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setAssignedContractor1(initialValues.assignedContractor1);
    setAssignedContractor2(initialValues.assignedContractor2);
    setStartDateTime(initialValues.startDateTime);
    setIsAvailable(initialValues.isAvailable);
    setContractor1Phone(initialValues.contractor1Phone);
    setContractor2Phone(initialValues.contractor2Phone);
    setDay(initialValues.day);
    setTime(initialValues.time);
    setMonthAsWord(initialValues.monthAsWord);
    setDayOfWeek(initialValues.dayOfWeek);
    setDayAsNumber(initialValues.dayAsNumber);
    setYearAsNumber(initialValues.yearAsNumber);
    setTimeAsString(initialValues.timeAsString);
    setErrors({});
  };
  const validations = {
    assignedContractor1: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new AvailableInstallations(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "AvailableInstallationsCreateForm")}
      {...rest}
    >
      <TextField
